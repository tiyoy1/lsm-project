        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.student.index') }}" class="btn btn-primary">Open Students</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.pending-students.index') }}" class="btn btn-primary">Open Pending Students</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.alumni.index') }}" class="btn btn-primary">Open Alumni</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.vision-mission.index') }}" class="btn btn-primary">Open Visi Misi</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.school-profile.index') }}" class="btn btn-primary">Open Profil Sekolah</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.student-works.index') }}" class="btn btn-primary">Open Karya Siswa</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="{{ route('legacy-admin.news.index') }}" class="btn btn-primary">Open News</a>
                </div>
            </div>
        </div>
    </div>
