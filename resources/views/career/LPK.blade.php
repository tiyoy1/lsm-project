        ...
        <div class="lpk-intro">
            ...
            <div class="lpk-image-wrapper">
                <div class="swiper lpk-image-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{ asset('img/SMK Metland Cileungsi.webp') }}" alt="SMK Metland Cileungsi" class="lpk-intro-image">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ asset('img/SMK Metland cibitung.webp') }}" alt="SMK Metland Cibitung" class="lpk-intro-image">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{ asset('img/kertajati.webp') }}" alt="Kertajati" class="lpk-intro-image">
                        </div>
                    </div>
